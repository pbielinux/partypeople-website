...
const socials = [
  ...
  { label: 'CONTACT@PARTYPEOPLE.WORLD', href: 'mailto:contact@partypeople.world' },
];
  ...
  return (
    <footer className="bg-white text-black w-full">
      <div className="container mx-auto px-4 py-20">
        <div className='grid grid-cols-1 lg:grid-cols-2 items-start'>
          ...
          <div className='flex flex-col border-2 border-black rounded-2xl p-6 space-y-2 h-auto'>
            ...
            <div className='flex flex-col border-2 border-black rounded-2xl'>
              <input className="p-3 rounded-2xl" type="text" placeholder='Email' />
        ...
        {/* Social Links */}
        <div className="flex justify-center items-center space-x-6 text-sm font-medium mb-8">
          <Image
            src="/images/icon-head.png" // Replace with the actual path to your logo
            alt="Party People Logo"
            width={50}
            height={50}
            className="h-12"
